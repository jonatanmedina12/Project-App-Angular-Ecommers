...
export class InventoryService {
  ...
  obtenerTodoElInventario(): Observable<InventarioDTO[]> {
    return this.http.get<InventarioDTO[]>(this.apiUrl);
  }
  ...
  actualizarInventario(productoId: number, inventarioDTO: InventarioDTO): Observable<InventarioDTO> {
    return this.http.put<InventarioDTO>(`${this.apiUrl}/${productoId}`, inventarioDTO);
  }
